...
SYSTEM = (
    "You are a very experienced and knowledgeable programmer supporting TACO, "
    "a trust assessment method for coding assistance tasks. Follow the task-specific "
    "instructions exactly."
)


TEST_COMPLETION_PROMPT = """\
You are a very experienced and knowledgeable programmer. You will get a question and answer from StackOverflow. Your task is to convert this question and answer into complete,concise and testable code in a Python environment by appropriately supplementing or rewriting them.
...
INTERPRETER_PROMPT = """\
You are a Python virtual executor responsible for simulating the execution of key lines of the given code, analyzing program operation according to the actual execution order of the code. 
...
ALIGNMENT_PROMPT = """\
You are a seasoned Stack Overflow answer-alignment reviewer.  
...
JAVA_TEST_COMPLETION_PROMPT = """\
You are a very experienced and knowledgeable programmer. You will get a question and answer from StackOverflow. Your task is to convert this question and answer into complete,concise and testable code in a Java environment by appropriately supplementing or rewriting them.
...
JAVA_INTERPRETER_PROMPT = """\
You are a Java virtual executor responsible for simulating the execution of key lines of the given code, analyzing program operation according to the actual execution order of the code. 
...
def get_prompts(language: str = "python") -> dict[str, str]:
    if language.lower() == "java":
        return {
            "test_completion": JAVA_TEST_COMPLETION_PROMPT,
            "interpreter": JAVA_INTERPRETER_PROMPT,
            "code_quality": CODE_QUALITY_PROMPT,
            "alignment": ALIGNMENT_PROMPT,
        }
    return {
        "test_completion": TEST_COMPLETION_PROMPT,
